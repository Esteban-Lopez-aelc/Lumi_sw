...
<head>
  ...
  <!-- Enlaces y bibliotecas asociadas; estilos bootstrap, leaflet -->
...
<body>
  ...
  <div class="navbar">
    ...
    if(isset($_SESSION['rol'])) {
        ...
        // Se realiza la consulta para encontrar el rol en la tabla de datos
        if($rol){
            ...
            // Si existe ese registro se accede a la pagina
  ...
  <!-- Contender del mapa princiál  -->
  <div id="map-container">
    <div id="map"></div>
    <!-- Barra lateral que contiene el formulario de administracion -->
    <div class="sidebar">
      <?php if(isset($_SESSION['rol'])): ?>
        <div id="reporteForm">
          <h2>Reparar poste</h2>
          <!-- Formulario reparar poste -->
        ...
        <div id="tablaPostesMalos">
          ...
          <table class="table">
            ...
            <tbody>
              <!-- php con las consultas que mostran los datos de la bd -->
              <?php
              // conexion
  ...
  <script>
    ...
    document.getElementById('reportForm').addEventListener('submit', function(event) {
      ...
      // Conexion con las funciones para reparar postes
    ...
    // php para visualizar el mapa y las capas del proyecto
    <?php if($rol): ?>
      // variable del mapa principal
    var mymap = L.map('map', {
...
<!-- Script para la funcion reparar poste, cambia el estado del poste en la bd -->
<script>
    function repararPoste() {
      var seriePoste = document.getElementById('seriePoste').value;

      // Busca los datos de reparar postes
