...
<head>
  ...
  <!-- Enlaces de bibliotecas usadas; estilos, bootstrap, leaflet,  -->
...
<body>
  <!-- barra de navegacion -->
  <div class="navbar">
    <!-- php para iniciar sesion y realizar consultas -->
    <?php
    session_start();
    ...
    if(isset($_SESSION['rol'])) {
        ...
        // Consulta para identificar si existe el usuario en la bd
        if($rol){
  ...
  <div id="map-container">
    <div id="map"></div>
    <!-- Barra lateral con el formulario de reportes -->
    <div class="sidebar">
      <!-- php para continuar con la sesion actva -->
      <?php if(isset($_SESSION['rol'])): ?>
        <!-- formulario de reporete -->
        <div id="reporteForm">
  ...
  <script src="https://unpkg.com/leaflet@1.7.1/dist/leaflet.js"
          ...
          crossorigin=""></script>
  <script>
    // Funcion evento para activar el reporte
    document.getElementById('reportForm').addEventListener('submit', function(event) {
      event.preventDefault();

      // Variables de poste, descripcion y datos
    ...
    // php para visualizar el mapa y capas adicionales
    <?php if($rol): ?>
    var mymap = L.map('map', {
