...
<body>
  <!-- barra de navegacion -->
  <div class="navbar">
    <a class="btn btn-primary btn-back" href="index.php">Regresar</a>
  </div>
<!-- contenedor del mapa  -->
  ...
  <script>
    ...
    // Variables (postes, vias, manzanas) y capas propias del proyecto
